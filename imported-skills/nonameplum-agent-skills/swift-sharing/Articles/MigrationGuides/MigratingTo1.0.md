...
Instead, exclusively use the [`withLock`]([Shared/with Lock( :file ID:file Path:line:column:)](Shared/withLock(_:fileID:filePath:line:column:).md))
...
For more information on this change, see [Mutating shared state](../Articles/MutatingSharedState.md).
