...
[`@Shared`]([`Sharing.Shared`](../Extensions/Shared.md)) properties. Depending on your exact situation you can do one of the
following:
...
[`fileStorage`]([Shared Reader Key/file Storage( :decoder:encoder:)](SharedReaderKey/fileStorage(_:decoder:encoder:).md)), _etc._), then the
