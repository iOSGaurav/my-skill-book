...
strategies: [`appStorage`]([Shared Reader Key/app Storage( :store:)](SharedReaderKey/appStorage(_:store:).md)),
[`fileStorage`]([Shared Reader Key/file Storage( :decoder:encoder:)](SharedReaderKey/fileStorage(_:decoder:encoder:).md)), and
[`inMemory`]([Shared Reader Key/in Memory( :)](SharedReaderKey/inMemory(_:).md)). These strategies are defined as conformances to
...
to use the [`.fileStorage`]([File system](PersistenceStrategies.md#File-system)) strategy or a
[custom persistence]([Custom persistence](PersistenceStrategies.md#Custom-persistence)) strategy.
