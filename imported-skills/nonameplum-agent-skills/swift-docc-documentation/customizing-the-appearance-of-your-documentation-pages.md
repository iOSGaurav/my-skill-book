...
> **Tip:** > For a more complete example of a fully customized documentation website, you
...
> **Note:** > You can find all the possible identifier values for every valid icon kind in
...
provides several [`Metadata`](../Reference Syntax/API Reference Syntax/Metadata.md) directives that allow you to customize just
