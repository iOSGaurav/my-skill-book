...
Further, the `diffTool` and `record` arguments have extra customization capabilities:
  ...
  * `diffTool` is now a [function]([Snapshot Testing Configuration/Diff Tool swift.struct](SnapshotTestingConfiguration/DiffTool-swift.struct.md)) 
  ...
  * `record` is now a [type]([Snapshot Testing Configuration/Record swift.struct](SnapshotTestingConfiguration/Record-swift.struct.md)) with 4
...
[configuration]([Snapshot Testing Configuration](SnapshotTestingConfiguration.md)) for a particular test or an entire suite you
