# Gotchas of Learn about a few gotchas to be aware of when using shared state in your application.
...
There is one nuance to be aware of when using [`@Shared`]([`Sharing.Shared`](../Extensions/Shared.md)) and 
[`@SharedReader`]([`Sharing.SharedReader`](../Extensions/SharedReader.md)) directly in a SwiftUI view. When the view is recreated 
...
as the article [Dynamic Keys](DynamicKeys.md).
