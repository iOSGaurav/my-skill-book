...
- **`Intro`**: Engaging introductory text and an image or video to display at the top of the page. **(optional)**
...
- **`Assessments`**: Assessments that test the reader's knowledge about the content described in the article. **(optional)**
- **`Image`**: An image that appears on the page. **(optional)**
