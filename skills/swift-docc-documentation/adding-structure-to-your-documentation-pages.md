...
[Formatting Your Documentation Content](../formatting-your-documentation-content.md). 
...
> **Tip:** > If you feel that a top-level topic group contains too many links, 
> it could be an indication that that you can further organize the links into subtopics.
> For more information, see the [Incorporate Hierarchy in Your Navigation](#Incorporate-Hierarchy-in-Your-Navigation) section below.
...
> **Important:** > If DocC can't resolve the symbol link in the level 1 header of the extension
...
> **Note:** > If you organize a member symbol into a topic group outside of the type that defines the member, 
...
- [Sloth Generators](SlothGenerators.md)
```
